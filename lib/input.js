  ...
  if (is.object(inputOptions)) {
    ...
    if (is.defined(inputOptions.text)) {
      if (is.object(inputOptions.text) && is.string(inputOptions.text.value)) {
        ...
        inputDescriptor.textAlign = (is.string(inputOptions.text.align) && is.inArray(inputOptions.text.align, Object.keys(alignReplacements)) && inputOptions.text.align) || alignReplacements['left'];
        ...
        inputDescriptor.textFontSize = (is.integer(inputOptions.text.fontSize) && inputOptions.text.fontSize) || 12;
